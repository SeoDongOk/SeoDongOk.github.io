    ...
    <footer>
      <div className="ambient-panel mt-20 rounded-[1.75rem] px-6 py-10">
        <div className="mb-8 text-center">
          <p className="text-xs tracking-[0.32em] text-stone-500 uppercase dark:text-stone-300">
            {copy.label}
          </p>
          <p className="mt-3 text-sm leading-7 text-stone-600 dark:text-stone-200">
            {copy.description}
          </p>
        </div>
        <div className="flex flex-col items-center">
          ...
          <div className="mb-2 flex space-x-2 text-sm text-stone-500 dark:text-stone-300">
          ...
          <div className="text-xs tracking-[0.24em] text-stone-500 uppercase dark:text-stone-300">
            {copy.caption}
          </div>
        </div>
      </div>
