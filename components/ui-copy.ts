...
export const uiCopy = {
  ko: {
    common: {
      ...
      searchArticles: '글 검색',
      readArticle: '글 읽기',
      blogIntro: '백테스트 · 자동화 · 전략 노트를 매일 쌓아두는 작업 일지입니다.',
  ...
  ja: {
    common: {
      ...
      readArticle: '記事を読む',
      blogIntro: 'バックテスト・自動化・戦略メモを毎日積み上げる作業ログです。',
  ...
  en: {
    common: {
      ...
      blogIntro: 'A daily working log of backtests, automation, and strategy notes.',
